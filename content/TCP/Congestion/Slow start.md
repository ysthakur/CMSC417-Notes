- A new [TCP](TCP/TCP.md) flow should start with a small [congestion window](TCP/Congestion/TCP%20Congestion.md#congestion-window) (slow start) to avoid overloading network
